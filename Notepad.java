...
final String aboutText=
	"<html><big>My Notepad</big><hr><hr>"
	+"<p align=right>Prepared by a Kuldeep!"
	+"<hr><p align=left>I Used jdk1.5 to compile the source code.<br><br>"
	+"<strong>Thanx 4 making it kuldeep</strong><br>"
	+"Ur Comments as well as bug reports r very welcome at<p align=center>"
	+"<hr><em><big>kuldeepgupta923@gmail.com</big></em><hr><html>";
}